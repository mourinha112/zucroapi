...
const saveCustomizationSchema = z.object({
  ...
  timerColor: z.string().default('#dc2626'),
  ...
  app.get('/customization', {
    ...
    return reply.send({
      ...
      customization: product.checkout_customization ? {
        ...
        timerColor: product.checkout_customization.timer_color,
  ...
  app.get('/customization/public/:productId', {
    ...
    return reply.send({
      ...
      customization: {
        ...
        timerColor: customization.timer_color,
